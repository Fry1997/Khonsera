...
### DragonPass — the active airport-experience partner (D52, short-term) · revenue · P12 (fast-track ⭐) + P13 (lounge)
*(Collinson is the long-term strategic TARGET — `integrations/collinson.ts` kept dormant, identical shapes, switch is one line.)*
