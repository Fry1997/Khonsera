...
(function () {
  ...
  .kc-face::before{
    ...
    z-index:0; --wv:calc(var(--cw,200px)*0.011);
    background-image:
      repeating-linear-gradient(45deg, rgba(255,255,255,0.55) 0, rgba(122,104,74,0.16) calc(var(--wv)*0.5), rgba(255,255,255,0.55) var(--wv)),
      repeating-linear-gradient(-45deg, rgba(255,255,255,0.55) 0, rgba(122,104,74,0.16) calc(var(--wv)*0.5), rgba(255,255,255,0.55) var(--wv));
