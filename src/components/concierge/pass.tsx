...
export type BoardingVM = {
  ...
  platformUnavailable?: boolean; // a live service exists but Darwin cannot currently confirm a platform
  platformChecking?: boolean; // a live platform lookup is in flight
