...
// Staff-only demonstration scenario. It is deliberately a separate data source
// from the signed-in user's Today: no itinerary rows are read, created or
// changed here. The scenario is rendered through the same LiveDay, TodaySpine,
// pass and navigation components as the real screen, so fixes and design changes
// carry to both without maintaining a second UI.
