...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      booking_intents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_intents_paired_booking_id_fkey";
      ...
      gaps: {
        Row: {
          ...
          id: string;
          itinerary_id: string;
          state: Database["public"]["Enums"]["gap_state"];
          to_stop_id: string | null;
          type: Database["public"]["Enums"]["gap_type"];
          updated_at: string;
        };
        Insert: {
          created_at?: string;
        ...
        Relationships: [
          {
            foreignKeyName: "gaps_from_stop_id_fkey";
          ...
          {
            foreignKeyName: "gaps_itinerary_id_fkey";
            columns: ["itinerary_id"];
            isOneToOne: false;
            referencedRelation: "itineraries";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "gaps_to_stop_id_fkey";
            columns: ["to_stop_id"];
            isOneToOne: false;
            referencedRelation: "stops";
            referencedColumns: ["id"];
      ...
      intention_anchors: {
        ...
        Relationships: [
          {
            foreignKeyName: "intention_anchors_intention_id_fkey";
          ...
          {
            foreignKeyName: "intention_anchors_stop_id_fkey";
            columns: ["stop_id"];
            isOneToOne: false;
            referencedRelation: "stops";
            referencedColumns: ["id"];
      ...
      intentions: {
        Row: {
          ...
          created_at: string;
          description: string;
          flexibility: Database["public"]["Enums"]["intention_flexibility"];
          id: string;
          itinerary_id: string;
          leave_by: string | null;
          state: Database["public"]["Enums"]["intention_state"];
          target: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "intentions_itinerary_id_fkey";
            columns: ["itinerary_id"];
            isOneToOne: false;
            referencedRelation: "itineraries";
            referencedColumns: ["id"];
      ...
      resource_states: {
        ...
        Relationships: [
          {
            foreignKeyName: "resource_states_itinerary_id_fkey";
            columns: ["itinerary_id"];
            isOneToOne: false;
            referencedRelation: "itineraries";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "resource_states_stop_id_fkey";
            columns: ["stop_id"];
            isOneToOne: false;
            referencedRelation: "stops";
            referencedColumns: ["id"];
      ...
      tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "tasks_itinerary_id_fkey";
            columns: ["itinerary_id"];
            isOneToOne: false;
            referencedRelation: "itineraries";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      can_access_itinerary: { Args: { itin: string }; Returns: boolean };
    ...
    Enums: {
      ...
      feasibility_status:
        ...
        | "not_recommended"
        | "not_possible";
      gap_state: "open" | "watching" | "resolved" | "dismissed";
      gap_type:
        | "transport_gap"
        | "accommodation_gap"
        | "unplanned_time"
      ...
      intent_status:
        ...
        | "abandoned"
        | "snoozed";
      intention_flexibility: "soft" | "promoted_to_hard";
      intention_state: "active" | "toggled_off";
      itinerary_status:
        | "draft"
        | "planning"
        | "planned"
