...
const segmentSchema = z.object({
  ...
  service_uid: z.string().trim().max(120).nullable().optional(),
  darwin_service_id: z.string().trim().max(240).nullable().optional(),
  ...
  await supabase
    ...
    .update({
      metadata: {
        ...
        service_uid: first.service_uid ?? null,
        darwin_service_id: first.darwin_service_id ?? null,
